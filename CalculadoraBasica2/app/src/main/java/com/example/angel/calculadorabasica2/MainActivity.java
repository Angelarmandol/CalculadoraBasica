...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttomSuma.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                a =  Integer.parseInt(numero1.getText().toString());
                b =  Integer.parseInt(numero2.getText().toString());
    ...
    public void suma(int datoA,int datoB){
        int result =0;
        try {
            if ((datoA > 0) && (datoB > 0)) {
                result = datoB * datoB;
    ...
    public void resta(int datoA,int datoB){
        int result =0;
        try {
            if ((datoA > 0) && (datoB > 0)) {
                result = datoB - datoB;
    ...
    public void divicion(int datoA,int datoB){
        int result =0;
        try {
            if ((datoA > 0) && (datoB > 0)) {
                result = datoB / datoB;
